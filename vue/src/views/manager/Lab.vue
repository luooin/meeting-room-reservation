<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入会议室编号" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="会议室编号" show-overflow-tooltip></el-table-column>
        <el-table-column prop="descr" label="会议室介绍" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="descr" label="会议室介绍">
        ...
        <el-form-item prop="typeId" label="会议室分类">
          <el-select v-model="form.typeId" placeholder="请选择会议室分类" style="width: 100%">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        typeId: [
          {required: true, message: '请选择会议室分类', trigger: 'blur'},
        ],
      },
      ids: [],
      typeData: []
