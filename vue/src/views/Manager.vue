      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            ...
            <el-menu-item index="/type" v-if="user.role === 'ADMIN'">会议室分类</el-menu-item>
            <el-menu-item index="/lab" v-if="user.role !== 'STUDENT'">会议室信息</el-menu-item>
            <el-menu-item index="/labStudent" v-else>会议室信息</el-menu-item>
          ...
          <el-submenu index="user" v-if="user.role === 'ADMIN'">
            ...
            <el-menu-item index="/labadmin">会议室管理员</el-menu-item>
