...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'labadmin', name: 'Labadmin', meta: { name: '会议室管理员' }, component: () => import('../views/manager/Labadmin') },
      { path: 'student', name: 'Student', meta: { name: '学生信息' }, component: () => import('../views/manager/Student') },
      { path: 'type', name: 'Type', meta: { name: '会议室分类' }, component: () => import('../views/manager/Type') },
      { path: 'lab', name: 'Lab', meta: { name: '会议室信息' }, component: () => import('../views/manager/Lab') },
      { path: 'labStudent', name: 'LabStudent', meta: { name: '会议室信息' }, component: () => import('../views/manager/LabStudent') },
